        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative py-20 bg-gradient-to-r from-blue-600 to-blue-800 overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed mb-12 opacity-0 animate-slide-up" style={{ animationDelay: "0.5s" }}>
                        ...
                        {[
                            ...
                            >
                                <div className="text-center">
                                    <div
                                        className={`w-12 h-12 ${product.color} rounded-full flex items-center justify-center font-bold text-white text-sm transition-all duration-300 hover:scale-110 mb-2 animate-bounce-slow`}
                                    >
                                        {product.symbol}
                                    </div>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold text-slate-900 mb-4 opacity-0 animate-slide-up" style={{ animationDelay: "0.3s" }}>
                            Core Commodities
                        </h2>
                        <p className="text-xl text-slate-600 max-w-3xl mx-auto opacity-0 animate-fade-in" style={{ animationDelay: "0.5s" }}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                        <div className="text-center p-6 bg-slate-50 rounded-xl opacity-0 animate-slide-up" style={{ animationDelay: "0.3s" }}>
                        ...
                        <div className="text-center p-6 bg-slate-50 rounded-xl opacity-0 animate-slide-up" style={{ animationDelay: "0.5s" }}>
                        ...
                        <div className="text-center p-6 bg-slate-50 rounded-xl opacity-0 animate-slide-up" style={{ animationDelay: "0.7s" }}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                <div className="bg-white p-6 rounded-lg shadow-sm opacity-0 animate-slide-up" style={{ animationDelay: "0.3s" }}>
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-sm opacity-0 animate-slide-up" style={{ animationDelay: "0.5s" }}>
                            ...
                            <div className="bg-slate-50 p-6 rounded-lg mb-6 opacity-0 animate-slide-up" style={{ animationDelay: "0.7s" }}>
                        ...
                        <div className="relative">
                            ...
                            />
                            <div className="absolute -bottom-6 -right-6 bg-blue-600 text-white p-4 rounded-lg shadow-lg opacity-0 animate-scale-up" style={{ animationDelay: "0.9s" }}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="order-2 lg:order-1 relative">
                            <Image
                                ...
                                style={{ animationDelay: "0.7s" }}
                            />
                            <div className="absolute -bottom-6 -left-6 bg-amber-500 text-slate-900 p-4 rounded-lg shadow-lg opacity-0 animate-scale-up" style={{ animationDelay: "0.9s" }}>
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                <div className="bg-slate-50 p-6 rounded-lg opacity-0 animate-slide-up" style={{ animationDelay: "0.3s" }}>
                                    <h4 className="font-semibold text-slate-900 mb-3">Technical Specifications</h4>
                                    <ul className="space-y-2 text-sm text-slate-600">
                                ...
                                <div className="bg-slate-50 p-6 rounded-lg opacity-0 animate-slide-up" style={{ animationDelay: "0.5s" }}>
                                    <h4 className="font-semibold text-slate-900 mb-3">Applications</h4>
                                    <ul className="space-y-2 text-sm text-slate-600">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative">
                            <Image
                                ...
                                style={{ animationDelay: "0.7s" }}
                            />
                            <div className="absolute -bottom-6 -right-6 bg-slate-700 text-white p-4 rounded-lg shadow-lg opacity-0 animate-scale-up" style={{ animationDelay: "0.9s" }}>
            ...
            <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-blue-100 mb-8 leading-relaxed opacity-0 animate-fade-in" style={{ animationDelay: "0.5s" }}>
